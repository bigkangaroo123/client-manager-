...
def edit(): 
    if 'clients' not in client_manager_db.get_all_clients():
        ...
        client_names = [client['name'] for client in client_manager_db.get_all_clients()]
    ...
    if action_type == "Archive":
        ...
        if unarchive_type == "Client":
            ...
            if not archived_clients:
                ...
                archived_client_names = [client['name'] for client in archived_clients]
            ...
            if not archived_projects:
                ...
                archived_project_names = [(client['name'], project['name']) for client in archived_projects for project in client['projects']]
